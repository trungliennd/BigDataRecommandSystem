...
import data.movive.MatrixItemAndFeatures;
import data.movive.MatrixRatingMovie;
...
public class ContentBased {
	...
	public int[] FindMaxPre(Vector a){
		...
		for(int i =0;i < m_test;i++) {
			...
			JacardOfFilm jacard_index = new JacardOfFilm(i,Jacard(a, b));
